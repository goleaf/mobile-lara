...
return [
    ...
    */
    ...
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'mobilelara'),
    ...
    */
    ...
    'deeplink_host' => env('NATIVEPHP_DEEPLINK_HOST', 'mobile-lara.test'),
    ...
    */
    ...
    'permissions' => [
        'NSCameraUsageDescription' => 'Mobile Lara uses the camera when you choose to capture photos or videos.',
