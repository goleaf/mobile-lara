...
<div class="grid gap-2">
    ...
    <select
        ...
        {{ $attributes->class([
            'min-h-12 w-full rounded-lg border bg-app-surface px-3.5 text-base text-app-ink shadow-[0_12px_24px_-22px_rgba(15,23,42,0.55)] outline-none transition focus:border-app-accent focus:bg-white focus:ring-2 focus:ring-app-accent/20 disabled:cursor-not-allowed disabled:bg-app-bg disabled:text-app-muted',
