<div wire:poll.15s="refreshStatus">
    @if ($isOffline)
        <section
            role="status"
            aria-live="polite"
            class="safe-x border-b border-amber-200 bg-amber-50 px-4 py-3 text-amber-950 shadow-sm   "
        >
            <div class="mx-auto flex w-full max-w-md items-center gap-3">
                <span class="flex size-9 shrink-0 items-center justify-center rounded-lg bg-amber-200 text-sm font-black text-amber-950  ">
                    !
                </span>
                ...
                <button
                    ...
                    class="inline-flex min-h-10 shrink-0 items-center justify-center rounded-lg bg-app-ink px-3 text-xs font-semibold text-white shadow-sm transition data-loading:pointer-events-none data-loading:opacity-70 hover:bg-app-ink/90 disabled:pointer-events-none disabled:opacity-60   "
                >
