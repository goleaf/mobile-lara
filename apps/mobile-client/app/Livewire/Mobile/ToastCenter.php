    ...
    private function toastPresentation(string $type): array
    {
        return [
            'success' => [
                'role' => 'status',
                'marker' => 'S',
                'wrapper_classes' => 'border-emerald-200 bg-emerald-50 text-emerald-950',
                'marker_classes' => 'bg-emerald-500 text-white',
                'action_classes' => 'border-emerald-200 bg-white text-emerald-800 hover:bg-emerald-100',
            ],
            'error' => [
                'role' => 'alert',
                'marker' => 'E',
                'wrapper_classes' => 'border-red-200 bg-red-50 text-red-950',
                'marker_classes' => 'bg-red-600 text-white',
                'action_classes' => 'border-red-200 bg-white text-red-800 hover:bg-red-100',
            ],
            'warning' => [
                'role' => 'status',
                'marker' => 'W',
                'wrapper_classes' => 'border-amber-200 bg-amber-50 text-amber-950',
                'marker_classes' => 'bg-amber-500 text-amber-950',
                'action_classes' => 'border-amber-200 bg-white text-amber-900 hover:bg-amber-100',
            ],
            'info' => [
                'role' => 'status',
                'marker' => 'I',
                'wrapper_classes' => 'border-sky-200 bg-sky-50 text-sky-950',
                'marker_classes' => 'bg-sky-500 text-white',
                'action_classes' => 'border-sky-200 bg-white text-sky-800 hover:bg-sky-100',
            ],
        ][$type] ?? [
            'role' => 'status',
            'marker' => 'I',
            'wrapper_classes' => 'border-app-line bg-app-surface text-app-ink',
            'marker_classes' => 'bg-app-accent text-app-accent-ink',
            'action_classes' => 'border-app-line bg-white text-app-ink hover:bg-app-bg',
        ];
    }
}
