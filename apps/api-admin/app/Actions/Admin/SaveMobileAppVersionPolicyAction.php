...
final class SaveMobileAppVersionPolicyAction
{
    ...
    private function payload(array $data, array $metadata = []): array
    {
        return [
            ...
            'applies_from_version' => $this->nullableString($data['applies_from_version'] ?? null),
            'applies_until_version' => $this->nullableString($data['applies_until_version'] ?? null),
    ...
    private function payloadFromSnapshot(array $snapshot): array
    {
        ...
        return [
            ...
            'applies_from_version' => $this->nullableString($snapshot['applies_from_version'] ?? null),
            'applies_until_version' => $this->nullableString($snapshot['applies_until_version'] ?? null),
