...
final class RecordRestoreController extends Controller
{
    public function __construct(
        private readonly MobileRecordContextResolver $context,
        private readonly RestoreTenantRecordAction $records,
    ) {}
    ...
    public function __invoke(Request $request, string $record): JsonResponse
    {
        ...
        $tenantRecord = $this->records->restore($tenantRecord, $tenant, $user, $request);
