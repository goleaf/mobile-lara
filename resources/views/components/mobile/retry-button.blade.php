...
@php
    ...
    ][$variant] ?? 'border border-app-line bg-app-surface text-app-ink shadow-sm hover:bg-app-bg active:bg-app-line/60 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800 dark:active:bg-zinc-700';
